...
const quieto = '<style>.mv-cupo .mv-cupo-barra i{width:var(--f)!important}*,*::before,*::after{animation-duration:0s!important;animation-delay:0s!important;transition:none!important}.reveal,.v2-sube{opacity:1!important;transform:none!important}</style>';
const PANTALLAS = [
...
PANTALLAS.forEach(([nombre, sel, off]) => {
  ...
  const out = path.resolve('../_vista/v67-movil-' + nombre + '.png');
...
const outH = path.resolve('../_vista/v67-movil-hoja.png');
